...
import json
from utility import is_number, TerminalScribeException, InvalidParameter
...
class Canvas:
    ...
    # Each Python file has its own set of globals, so we need to pass them in now externally since everything is in separate files
    # 'g' is passed in for global lookup
    def fromDict(data, g):
